...
class Simple(Scoring): 
    """ 
        Subclase del objeto "Scoring" que se encarga de los cálculos relacionados con la recomendación simple
    """
    ...
    def calcular_scores(self, dataset: Conjuntos, fila_num_user: int, es_cero:int):
        ...
        termino1 + termino2 : np.ndarray
            Las puntuaciones del sistema para las películas que el usuario no ha puntuado.
        filtro_a_puntuar : np.ndarray
            Filtro que dependiendo del valor "es_cero", dando a filtro_no_puntuados o filtro_puntuados
