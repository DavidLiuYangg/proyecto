...
class Conjuntos(abc.ABC): 
    """
    Objeto abastracto que se encarga de cargar y guardar la matriz de valoraciones y la matriz de elementos de los diferentes tipos de datasets
    """
    def __init__(self): 
    ...
    def cargar_datos(self): 
        """
        Función abstracta que se encarga de carga la matriz de valoraciones y elementos apartir de los diferentes conjuntos de datos
        Raises
        ------
        NotImplementedError
    ...
    def get_elementos_filtro(self, filtro_a_puntuar: np.ndarray): 
        ...
        Examples
        --------
        elementos = conjutnos.get_elementos_filtr(filtro_a_puntuar)
        """
