...
class Action(abc.ABC):
    """
    Clase abstracta que se encarga de gestionar el cálculo de puntuaciones para las recomendaciones y evaluaciones.
    """
    ...
    def calcular(self, scoring: Scoring, dataset: Conjuntos, fila_num_user: int , es_cero: int):
        """
        Calcula las puntuaciones del sistema así como los elementos puntuados y los devuelve.
        ...
        filtro : TYPE
            El filtro usado para calcular las puntuaciones, que pueden ser las puntuadas o no puntuadas. 
