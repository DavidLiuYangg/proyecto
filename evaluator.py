...
class Evaluator(Action):
    ...
    evaluaciones y mostrarlas por pantalla.
    """
    
    def get_evaluation(self, scoring: Scoring, dataset: Conjuntos, 
                       fila_num_user: int, es_cero: int=1):
        """
        Obtener el error entre los scores calculados por el sistema y las 
        calificaciones del usuario y mostrarlas.
